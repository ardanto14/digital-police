...
caffe_root = "/content/C3D/C3D-v1.0/"
...
if __name__ == '__main__':
    count=0
    for file in os.listdir("/content/folderOnColab/Robbery"):
      if file.split('.')[0] + '.txt' in os.listdir("/content/folderOnColab/out/Robbery/"):
        
        print("skipping " + file)
        continue

      read_file="/content/folderOnColab/Robbery/"
      write_file="/content/folderOnColab/out/Robbery/"
